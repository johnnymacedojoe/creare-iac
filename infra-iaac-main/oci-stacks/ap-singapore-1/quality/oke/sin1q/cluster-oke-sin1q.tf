module "cluster-oke-sin1q" {
  source = "../../../modules/new-oke"


  compartment_id     = var.BU-corp
  kubernetes_version = "v1.29.1"
  name               = "cluster-oke-sin1q"
  vcn_id             = module.vcn-oci-oke-sin1q.vcn_id
  type               = "BASIC_CLUSTER"
  ...
  endpoint_config = {
    ...
    subnet_id            = module.vcn-oci-oke-sin1q.subnet_ids["sn-oci-oke-sin1q1"]
  }
  ...
  options = {
    ...
    services_cidr                   = "10.171.0.0/16"
    service_lb_subnet_ids           = [module.vcn-oci-oke-sin1q.subnet_ids["sn-oci-oke-sin1q0"]]
  }
  ...
  node_pools = [
    {
      ...
      placement_configs_subnet_id               = module.vcn-oci-oke-sin1q.subnet_ids["sn-oci-oke-sin1q8"]
      size                                      = 2
      cni_type                                  = "OCI_VCN_IP_NATIVE" //FLANNEL_OVERLAY
      pod_subnet_ids                            = [module.vcn-oci-oke-sin1q.subnet_ids["sn-oci-oke-sin1q8"]]
      node_pool_image_id                        = var.img-oke-amd-1-29-1
...
module "nsg-oke-pods" {
  ...
  nsg_rules = [
    ...
    },
    {
      ...
      protocol    = "all"          // ICMP ("1"), TCP ("6"), UDP ("17")
      source_type = "CIDR_BLOCK"   // or "NETWORK_SECURITY_GROUP"
      source      = "10.21.8.0/21" //module.nsg-qa-lbgw-cs-smartwatch.nsg_id
      min_port    = null
      max_port    = null
