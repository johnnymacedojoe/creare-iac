module "oci_core_instance_gateshead2" {
  ...
  instance_name               = "gateshead2"
  private_ip                  = "10.1.1.132"
...
output "ip_address_gateshead2" {
  value = module.oci_core_instance_gateshead2.instance_ip
}
