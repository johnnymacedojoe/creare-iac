...
variable "nsg-malaga" { default = "ocid1.networksecuritygroup.oc1.sa-saopaulo-1.aaaaaaaaoexdpwnyfoauds7o7sjshqfzpnehcaieqzzdsqeqyzxlbi4pwfxq" }
variable "nsg-sevilha" { default = "ocid1.networksecuritygroup.oc1.sa-saopaulo-1.aaaaaaaakhm5x73wofkumtipwqvno2rosnhfmqpjt3qnbd5tbfsqvqj7xyba" }

variable "bucket_namespace" { default = "grkocmhf7oyf" }

variable "defined_tags_set" {
  type = map(string)
  default = {
    "Creare-Tags.Managed"     = "Terraform"
    "Creare-Tags.Environment" = "Production"
  }
}