module "nlb-pd-lbgw-cs-g5-v6" {
  source                     = "../../../modules/new-nlb-v2"
  compartment_id             = var.BU-Safety-compartment_ocid
  display_name               = "pd-lbgw-cs-g5-v6"
  is_private                 = false
  is_preserve_source         = false
  subnet_id                  = var.sn-oci-spo1p0
  nlb_ip_version             = "IPV4"
  network_security_group_ids = [module.nsg-pd-lbgw-cs-g5-v6.nsg_id]        //[module.oci_nsg.nsg_id]
  public_ip                  = module.public-ip-pd-lbgw-cs-g5-v6.public_ip //Can be omitted
  ...
  backend_sets = [
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_devon.instance_id, ip_address = "10.1.1.100", port = 21100 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_devon.instance_id, ip_address = "10.1.1.100", port = 9080 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_devon.instance_id, ip_address = "10.1.1.100", port = 23010 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_devon.instance_id, ip_address = "10.1.1.100", port = 1936 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_devon.instance_id, ip_address = "10.1.1.100", port = 8881 }
      ]
    }
  ]
  listeners = [
...
module "public-ip-pd-lbgw-cs-g5-v6" {
