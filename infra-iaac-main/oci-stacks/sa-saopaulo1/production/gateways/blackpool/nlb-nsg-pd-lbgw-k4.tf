module "nlb-pd-lbgw-cs-k4" {
  source                     = "../../../modules/new-nlb-v2"
  compartment_id             = var.production
  display_name               = "pd-lbgw-cs-k4"
  is_private                 = false
  is_preserve_source         = false
  subnet_id                  = var.sn-oci-spo1p0
  nlb_ip_version             = "IPV4"
  network_security_group_ids = [module.nsg-pd-lbgw-cs-k4.nsg_id]        //[module.oci_nsg.nsg_id]
  public_ip                  = module.public-ip-pd-lbgw-cs-k4.public_ip //Can be omitted
  ...
  backend_sets = [
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9090 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9091 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9092 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9093 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9094 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9095 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9096 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9097 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9098 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_blackpool.instance_id, ip_address = "10.1.1.91", port = 9099 }
      ]
    }
  ]
  listeners = [
...
module "public-ip-pd-lbgw-cs-k4" {
...
module "nsg-pd-lbgw-cs-k4" {
  source         = "../../../modules/new-nsg"
  compartment_id = var.production
  vnc_id         = var.vcn-oci-spo1p
  nsg_name       = "nsg-pd-lbgw-cs-k4"
  defined_tags   = var.defined_tags_set
  nsg_rules = [
    {
      direction        = "EGRESS"
...
output "nsg-pd-lbgw-cs-k4-id" {
  value = module.nsg-pd-lbgw-cs-k4.nsg_id
}
