...
module "nsg-qa-lbgw-cs-h7" {
  ...
  nsg_rules = [
    ...
    },
    {
      ...
      source_type = "CIDR_BLOCK" // or "CIDR_BLOCK"
...
output "nsg-qa-lbgw-cs-h7" {
  value = module.nsg-qa-lbgw-cs-h7.nsg_id
}
