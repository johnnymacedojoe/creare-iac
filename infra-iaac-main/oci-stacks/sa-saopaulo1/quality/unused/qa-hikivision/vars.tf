...
variable "img-windows-h7-base-image-2016" { default = "ocid1.image.oc1.sa-saopaulo-1.aaaaaaaaw6bt2tjetax5pwc36m7vwgg7mipef2bqtzfye6cc3dhbajcm6xya" }
...
variable "bv-salford-disk-d" { default = "ocid1.volume.oc1.sa-saopaulo-1.abtxeljrlbqgozjx4ywwtghi37uovlh3m7reyclc6lw42wp6mifinencrkzq" }
