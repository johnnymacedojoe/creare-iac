module "nsg-salford" {
  ...
  nsg_rules = [
    ...
    },
    {
      ...
      protocol    = "6"                             // ICMP ("1"), TCP ("6"), UDP ("17")
      source_type = "NETWORK_SECURITY_GROUP"        // or "NETWORK_SECURITY_GROUP"
      source      = module.nsg-qa-lbgw-cs-h7.nsg_id //module.nsg-qa-lbgw-cs-smartwatch.nsg_id
      min_port    = null
      max_port    = null
    ...
    },
    {
      ...
      protocol    = "6"                       // ICMP ("1"), TCP ("6"), UDP ("17")
      source_type = "NETWORK_SECURITY_GROUP"  // or "NETWORK_SECURITY_GROUP"
      source      = module.nsg-swinton.nsg_id //module.nsg-qa-lbgw-cs-smartwatch.nsg_id
      min_port    = null
      max_port    = null
      description = "Opening all ports from swinton instance"
    } /*,
    {
      direction        = "INGRESS"
      protocol         = "6"                      // ICMP ("1"), TCP ("6"), UDP ("17")
      source_type      = "NETWORK_SECURITY_GROUP" // or "NETWORK_SECURITY_GROUP"
      source           = var.nsg-swinton//module.nsg-qa-lbgw-cs-smartwatch.nsg_id
      min_port         = 559
      max_port         = 559
      description = "Cliente Web para transmissão em Google Chrome, Firefox ou Safari (WebSocket)"
    },
    ...
    },
    {
      ...
      min_port         = 443
      max_port         = 443
      description = "Listener Download 443"
    },
    {
      direction        = "INGRESS"
      protocol         = "6"                      // ICMP ("1"), TCP ("6"), UDP ("17")
      ...
      min_port         = 80
      max_port         = 80
      description = "Listener Download 80"
    },
    {
      direction        = "INGRESS"
      protocol         = "6"                      // ICMP ("1"), TCP ("6"), UDP ("17")
      ...
      min_port         = 8208
      max_port         = 8208
      description = "Third-Party Integration OpenAPI"
    }*/
  ]
}

output "nsg_id" {
  value = module.nsg-salford.nsg_id
}
