module "nsg-swinton" {
  ...
  nsg_rules = [
    ...
    },
    {
      ...
      protocol    = "6"                       // ICMP ("1"), TCP ("6"), UDP ("17")
      source_type = "NETWORK_SECURITY_GROUP"  // or "NETWORK_SECURITY_GROUP"
      source      = module.nsg-salford.nsg_id //module.nsg-qa-lbgw-cs-smartwatch.nsg_id
      min_port    = null
      max_port    = null
      description = "Opening all ports from salford instance"
    } /*,
    {
      direction        = "INGRESS"
      protocol         = "6"                      // ICMP ("1"), TCP ("6"), UDP ("17")
    ...
    },
    {
      ...
      min_port         = 40030
      max_port         = 40030
      description = "Integration listener creare port 40030"
    }*/
  ]
}
