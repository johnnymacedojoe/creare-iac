...
variable "Production-compartment_ocid" { default = "ocid1.compartment.oc1..aaaaaaaambsllglkxmaxooq45tke4awlmreuxs3lpm335rk7a7rjlqh3nkqa" }
variable "Quality-compartment_ocid" { default = "ocid1.compartment.oc1..aaaaaaaaet2gg6mmzr56mohsbyvmttpxlcnnib4keevli6kvgq76mwtbngwq" }
variable "SysAdmin-compartment_ocid" { default = "ocid1.compartment.oc1..aaaaaaaaye6ty3tkn64mvvy3j4yf637lg2yykta36t6wht6ws7ilcvtrxm3a" }
