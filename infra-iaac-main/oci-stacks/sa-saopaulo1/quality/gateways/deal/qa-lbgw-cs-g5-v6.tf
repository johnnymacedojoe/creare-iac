module "nlb-qa-lbgw-cs-g5-v6" {
  source                     = "../../../modules/new-nlb"
  compartment_id             = var.BU-Safety-compartment_ocid
  display_name               = "qa-lbgw-cs-g5-v6"
  is_private                 = false
  is_preserve_source         = false
  subnet_id                  = var.sn-oci-spo1p0
  nlb_ip_version             = "IPV4"
  network_security_group_ids = [module.nsg-qa-lbgw-cs-g5-v6.nsg_id]        //[module.oci_nsg.nsg_id]
  public_ip                  = module.public-ip-qa-lbgw-cs-g5-v6.public_ip //Can be omitted
  backend_sets = [
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_deal.instance_id, ip_address = "10.1.2.100", port = 21100 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_deal.instance_id, ip_address = "10.1.2.100", port = 9080 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_deal.instance_id, ip_address = "10.1.2.100", port = 23010 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_deal.instance_id, ip_address = "10.1.2.100", port = 1936 }
      ]
    },
    {
      ...
      backends = [
        { target_id = module.oci_core_instance_deal.instance_id, ip_address = "10.1.2.100", port = 8881 }
      ]
    }
  ]
  listeners = [
...
module "public-ip-qa-lbgw-cs-g5-v6" {
