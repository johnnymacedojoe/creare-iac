module "oci_core_instance_deal" {
  ...
  nsg_ids                     = [module.nsg-deal.nsg_id, var.nsg-spo1p-linux-server]
  ...
  volumes = [
    {
      display_name = "bv-deal-docker-containers"
      size_in_gbs  = 50
      device       = "/dev/oracleoci/oraclevdb"
    },
    {
      display_name = "bv-deal-var-lib-docker"
      size_in_gbs  = 50
...
output "ip_address_deal" {
  value = module.oci_core_instance_deal.instance_ip
}
